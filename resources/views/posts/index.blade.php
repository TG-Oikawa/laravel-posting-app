    ...
    <div class="wrapper">
            ...
            <nav class="navbar navbar-light bg-light">
                <div class="container">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a href="{{ route('logout') }}" class="enav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">ログアウト</a>
        ...
        <main>
            <div class="container">
                ...
                @if (session('error_message'))
                    <p class="text-dander">{{ session('error_message') }}</p>
                @endif
